...
class RecipientsFormScreen extends StatefulWidget {
  final Map<String, dynamic>? item;
  const RecipientsFormScreen({super.key, this.item});

  @override
  State<RecipientsFormScreen> createState() => _RecipientsFormScreenState();
}

class _RecipientsFormScreenState extends State<RecipientsFormScreen> {
  ...
  Widget build(BuildContext context) {
    final prov = context.watch<RecipientsProvider>();
    final isEdit = widget.item != null;

    return Scaffold(
      appBar: AppBar(
          title: Text(isEdit ? 'Editar Destinatarios' : 'Nuevo Destinatarios')),
      body: Form(
        key: _formKey,
        child: ListView(
