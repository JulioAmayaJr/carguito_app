...
class DeliveryPointsListScreen extends StatefulWidget {
  const DeliveryPointsListScreen({super.key});

  @override
  State<DeliveryPointsListScreen> createState() =>
      _DeliveryPointsListScreenState();
}

class _DeliveryPointsListScreenState extends State<DeliveryPointsListScreen> {
  String _search = '';
  ...
  void _showActions(
    ...
    DeliveryPointsProvider provider,
  ) {
            ...
            children: [
              ...
              _DeliveryActionTile(
                ...
                onTap: () {
                  ...
                  context.push('/delivery_points/edit', extra: item);
                },
              ),
  ...
  Widget build(BuildContext context) {
    final provider = context.watch<DeliveryPointsProvider>();
    final items = _filteredItems(provider.items);

    return Scaffold(
      backgroundColor: const Color(0xFFF6F6F8),
      floatingActionButton: FloatingActionButton(
        onPressed: () => context.push('/delivery_points/new'),
                ...
                : ListView(
                    ...
                    children: [
                      ...
                      const Padding(
                        padding: EdgeInsets.symmetric(horizontal: 16),
                        child: Text(
                          'Administra los puntos de entrega registrados',
                          style: TextStyle(
                            fontSize: 14,
                      ...
                      if (items.isEmpty)
                        const Padding(
                          padding: EdgeInsets.symmetric(horizontal: 12),
                          child: _EmptyDeliveryCard(),
                        )
                      else
                        ...items.map(
                          (item) => Padding(
                            padding: const EdgeInsets.fromLTRB(12, 0, 12, 14),
                            child: _DeliveryPointCard(
                      ...
                      Padding(
                        ...
                        child: _CreateNewDeliveryCard(
                          onTap: () => context.push('/delivery_points/new'),
                        ),
                      ),
                    ],
                  ),
...
class _DeliveryBannerCard extends StatelessWidget {
  const _DeliveryBannerCard();
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        image: const DecorationImage(
          image: AssetImage('assets/delivery/delivery1.png'),
          fit: BoxFit.cover,
        ),
      ),
    );
...
class _CreateNewDeliveryCard extends StatelessWidget {
  final VoidCallback onTap;

  const _CreateNewDeliveryCard({
    required this.onTap,
  });
            ...
            children: [
              ...
              Expanded(
                child: Column(
                  ...
                  children: const [
                    Text(
                      'Registrar nuevo punto de entrega',
                      style: TextStyle(
                        fontSize: 16,
                        fontWeight: FontWeight.w800,
                    ...
                    SizedBox(height: 4),
                    Text(
                      'Toca aquí para agregar un punto de entrega',
                      style: TextStyle(
                        fontSize: 14,
                        fontWeight: FontWeight.w500,
...
class _DeliveryActionTile extends StatelessWidget {
  final IconData icon;
  final Color iconColor;
  final String title;
  final VoidCallback onTap;

  const _DeliveryActionTile({
    required this.icon,
